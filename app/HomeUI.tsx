...
//   const setImgIndexSafe = (callbackOrValue: number | ((prev: number) => number)) => {
//     setImgIndex((prev) => {
//       const next =
...
//   const onDragEnd = (event: MouseEvent, info: { offset: { x: number } }) => {
...
//                 onClick={() => (window.location.href = "/pages/post_pages")}
//                 whileHover={{
//                   scale: 1.08,
